...
-- DUAL 이라는 DUMMY TABLE을 준비해놓고
-- SQL연산을 수행할때 사용하도록 만들어 놨다.
-- (다른 SQL에서는 SELECT 30 + 40; 해도되는거)
...
-- 보이는 것과 달리 실제 데이터는
-- 2021-04-2800:00:00 형식으로 ROUND가 적용된다
-- (ROUND하면 시간이 초기화된다..? 반올림해서?)
SELECT
